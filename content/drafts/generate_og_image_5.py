...
OUTPUT_PATH = "/Users/cooperanderson/projects/signal-dispatch/content/drafts/5-og-image.png"
...
BRAND_BEBAS = "/Users/cooperanderson/projects/signal-dispatch/content/brand/BebasNeue-Regular.ttf"
if os.path.exists(BRAND_BEBAS) and not os.path.exists(BEBAS_PATH):
    import shutil
    shutil.copy(BRAND_BEBAS, BEBAS_PATH)
    print(f"  Copied BebasNeue from brand directory.")
...
# ---------------------------------------------------------------------------
# 2. Main title: "THE COMPOUND SHOCK"
#    Single line, Bebas Neue, large
# ---------------------------------------------------------------------------
TITLE_LINE1 = "THE COMPOUND SHOCK"
...
# 3. Subtitle
# ---------------------------------------------------------------------------
SUBTITLE_TEXT = "Why three simultaneous pressures make this recession different"
...
# ---------------------------------------------------------------------------
# 5. Metadata row: "DEEP DIVE | MARCH 18, 2026"
# ---------------------------------------------------------------------------
META_TEXT = "DEEP DIVE  |  MARCH 18, 2026"
draw_tracked_text(
    draw,
    (PADDING_X, META_Y),
    META_TEXT,
